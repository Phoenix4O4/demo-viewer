...
export class DemoParserText extends DemoParser {
	...
	private read_appearance(p : TextPointer, comparison : ReaderAppearance|null = null, inherit_overlays=true) : ReaderAppearance|null {
		...
		if(p.curr() != ';') {
			...
			if(appearance.plane == 10  || appearance.plane == -200 || appearance.plane == -410 || appearance.plane == -620 && !(appearance.layer == 20021 || appearance.layer == 20020) && appearance.blend_mode != 3) appearance.blend_mode = 4;
